      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
        <div className="bg-white dark:bg-[#3A4565] rounded-xl shadow-md p-6 text-center">
          ...
          <div className="flex justify-center gap-4 text-gray-600 dark:text-white">
            <a
              href="https://www.instagram.com/lacerda.xs/"
              target="_blank"
            ...
            <a
              href="https://www.linkedin.com/in/murilo-lacerda-9bba4a1b1/"
              target="_blank"
              rel="noopener noreferrer"
            >
        ...
        <div className="bg-white dark:bg-[#3A4565] rounded-xl shadow-md p-6 text-center">
          ...
          <div className="flex justify-center gap-4 text-gray-600 dark:text-white">
            <a
              href="https://www.instagram.com/pio.vg/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <i className="fa-brands fa-instagram"></i>
            ...
            <a
              href="https://www.linkedin.com/in/gabriel-pio-vargas/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <i className="fa-brands fa-linkedin"></i>
        ...
        <div className="bg-white dark:bg-[#3A4565] rounded-xl shadow-md p-6 text-center">
          ...
          <div className="flex justify-center gap-4 text-gray-600 dark:text-white">
            <a
              href="https://www.instagram.com/__ygorqueiroz/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <i className="fa-brands fa-instagram"></i>
            ...
            <a
              href="https://www.linkedin.com/in/ygor-queiroz-143441325/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <i className="fa-brands fa-linkedin"></i>
        ...
        <div className="bg-white dark:bg-[#3A4565] rounded-xl shadow-md p-6 text-center">
          ...
          <div className="flex justify-center gap-4 text-gray-600 dark:text-white">
            <a
              href="https://www.instagram.com/_caramico.mah_/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <i className="fa-brands fa-instagram"></i>
            ...
            <a
              href="https://www.linkedin.com/in/marcella-caramico-87a9a9336/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <i className="fa-brands fa-linkedin"></i>
